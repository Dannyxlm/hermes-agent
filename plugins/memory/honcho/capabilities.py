...
REQUIRED_CAPABILITIES = frozenset({
    ...
    "peer_handle",
    "session_handle",
    "session_peer_config_precedence",
    "session_add_peers_readback",
    "reasoning_config_readback",
    "summary_config_readback",
    "dream_config_readback",
    "card_create_config_readback",
    "tools_only_session_no_context",
    "message_add",
    "message_metadata_write",
    "peer_card_read",
    "peer_card_write_shape",
    "human_message_search_filters",
    "peer_context_scoped_parameters",
    "peer_representation_scoped_parameters",
    "conclusion_list",
    "conclusion_query",
    "conclusion_create",
    "reasoning_chat",
