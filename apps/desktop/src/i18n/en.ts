...
export const en: Translations = {
  ...
  updates: {
    ...
    desktopUpstreamTitle: 'Desktop upstream',
    desktopUpstreamSubtitle: 'Read-only comparison of this packaged app against NousResearch/main.',
    desktopUpstreamReady: 'Official upstream status is current.',
    desktopUpstreamStale: 'Showing cached official upstream status.',
    desktopUpstreamError: 'Official upstream status is unavailable.',
    desktopUpstreamUnavailable: 'A trustworthy packaged-app identity is not available.',
    desktopUpstreamDirty: 'This app was built from a dirty source tree; the count does not include those local edits.',
    desktopUpstreamBehind: 'Behind official upstream',
    desktopUpstreamAhead: 'Fork-only commits',
    desktopUpstreamInstalled: 'Packaged app',
