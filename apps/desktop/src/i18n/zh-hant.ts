...
export const zhHant = defineLocale({
  ...
  updates: {
    ...
    desktopUpstreamTitle: '桌面端上游狀態',
    desktopUpstreamSubtitle: '以唯讀方式比較目前封裝應用程式與 NousResearch/main。',
    desktopUpstreamReady: '官方上游狀態為最新。',
    desktopUpstreamStale: '正在顯示快取的官方上游狀態。',
    desktopUpstreamError: '無法取得官方上游狀態。',
    desktopUpstreamUnavailable: '無法確認可信的桌面應用程式建置身分。',
    desktopUpstreamDirty: '此應用程式由含未提交修改的原始碼建置；提交數不包含這些本機修改。',
    desktopUpstreamBehind: '落後官方上游',
    desktopUpstreamAhead: '分支專屬提交',
    ...
    managedInvalid: '來源監控狀態無效。',
    managedUnreadable: '無法讀取來源監控狀態。',
    managedRunningRelease: '目前執行版本',
    managedUpstream: '上游',
    managedCommitsBehind: count => `落後上游 ${count} 個提交`,
    managedCandidate: '候選版本',
    ...
    managedUnknown: '未知',
    managedBlockers: '阻塞項目',
    managedNextAction: '下一步',
    managedRefreshRequested: '已請求唯讀來源重新整理。',
    managedCheckNow: '立即檢查',
