...
export const zh: Translations = {
  ...
  updates: {
    ...
    desktopUpstreamTitle: '桌面端上游状态',
    desktopUpstreamSubtitle: '以只读方式比较当前打包应用与 NousResearch/main。',
    desktopUpstreamReady: '官方上游状态为最新。',
    desktopUpstreamStale: '正在显示缓存的官方上游状态。',
    desktopUpstreamError: '无法获取官方上游状态。',
    desktopUpstreamUnavailable: '无法确认可信的桌面应用构建身份。',
    desktopUpstreamDirty: '此应用由含未提交修改的源码构建；提交数不包含这些本地修改。',
    desktopUpstreamBehind: '落后官方上游',
    desktopUpstreamAhead: '分叉专属提交',
    ...
    managedInvalid: '源监控状态无效。',
    managedUnreadable: '无法读取源监控状态。',
    managedRunningRelease: '当前运行版本',
    managedUpstream: '上游',
    managedCommitsBehind: count => `落后上游 ${count} 个提交`,
    managedCandidate: '候选版本',
    ...
    managedUnknown: '未知',
    managedBlockers: '阻塞项',
    managedNextAction: '下一步',
    managedRefreshRequested: '已请求只读源刷新。',
    managedCheckNow: '立即检查',
    managedBuildCandidate: '构建候选版本',
    managedRequestingCandidate: '正在请求…',
    managedRequestOnlyNotice: '这些按钮只会发出外部请求，不会更改或重启生产环境。',
    updateNow: '立即更新',
    maybeLater: '稍后再说',
    ...
    applyStatus: {
      ...
      candidateRequested: '已请求构建不可变候选版本。生产环境未更改。'
    }
  },
