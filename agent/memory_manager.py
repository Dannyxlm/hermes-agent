...
class MemoryManager:
    ...
    def add_provider(self, provider: MemoryProvider) -> None:
        ...
        tool_count = sum(routed is provider for routed in self._tool_to_provider.values())
        logger.info("Memory provider '%s' registered (%d tools)", provider.name, tool_count)
