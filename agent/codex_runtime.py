...
def run_codex_app_server_turn(agent, *, user_message: str, original_user_message: Any, messages: List[Dict[str, Any]],
                              ...
                              plugin_user_context: str = "", ext_prefetch_cache: str = "") -> Dict[str, Any]:
    ...
    # Enrich only the request: ephemeral context must not enter persisted messages.
    from agent.turn_context import compose_user_api_content
    request_user_message = compose_user_api_content(user_message, ext_prefetch_cache, plugin_user_context)
    if request_user_message is None:
