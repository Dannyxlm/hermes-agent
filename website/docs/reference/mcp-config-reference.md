...
| `parked_retry_interval` | number | both | Self-probe cadence after a server is parked (default: `300`, floored at 5s). Use a shorter value only for local or frequently maintained backends |
